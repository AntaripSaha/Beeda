      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title">Add Worker Service</h4>
            <p class="card-category">(Service information)</p>
          </div>
          <div class="card-body">
            <form action="{{route('worker.service.add.submit')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="">
                    ...
                    <input type="hidden" name="category_type" id="category_type" value="3" />
                    <br>
