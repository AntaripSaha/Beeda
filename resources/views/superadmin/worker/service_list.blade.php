    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12" style="text-align:right;">
                <a href="{{route('worker.service.add')}}" class="btn btn-primary"><i style="font-size:25px;" class="material-icons">add</i> Add New</a>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card card-stats">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            ...
                            <a class="service_btn" href="{{route('worker.service.store.list', ['id' => $service->id])}}" title="Stores" style="color:#e863ff;"><i style="font-size:20px;" class="material-icons service_icon">store</i></a>
                            <a class="service_btn" href="{{route('transport.ride.list', ['service' => $service->id])}}" title="Appoinments" style="color:#e863ff;"><i style="font-size:20px;" class="material-icons service_icon">shopping_bag</i></a>
                            <a class="service_btn" href="{{route('worker.service.edit', ['id' => $service->id])}}" title="Edit" style="color:#e863ff;"><i style="font-size:20px;" class="material-icons service_icon">edit</i></a>
                        </div>
