          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{route('service.color.edit.submit')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" value="{{$clr->id}}" name="id" />
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Name</label>
                          <input type="text" name="name" value="{{$clr->name}}" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="color" name="color" value="{{$clr->code}}" />
