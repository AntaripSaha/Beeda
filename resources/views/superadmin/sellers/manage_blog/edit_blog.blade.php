                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <textarea class="form-control" name="short_description" rows="5">{{ $blog->short_description }}</textarea>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <textarea class="form-control" name="meta_description" rows="5">{{ $blog->meta_description }}</textarea>
                              </div>
                            </div>
                          </div>
                      </div>
