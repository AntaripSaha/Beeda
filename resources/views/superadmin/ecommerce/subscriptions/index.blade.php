            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <a href="{{route('ecommerce_subscription.add')}}" class="btn btn-info" style="float:right;"><i class="material-icons">add</i> Add New</a>
                  <h4 class="card-title mt-0" style="padding-top: 7px;margin-left: 5px;font-size: 17px;">Subscription Package List</h4>
                </div>
                <div class="card-body">
...
<script>
  $(function () {
    $("#example1").DataTable({
      ...
      serverSide: true,
      order: [0, "asc"],
      ajax: "{{ route('ecommerce_subscription.index') }}",
      columns: [
          {data: 'id', name: 'id'},
          ...
          {data: 'remaining_notification', name: 'remaining_notification'},
          {data: 'amount', name: 'amount'},
          {data: 'discount', name: 'discount'},
          {data: 'product_listing', name: 'product_listing'},
...
function publish(id)
{
  ...
  if($(mainParent).find('input.publish'+id).is(':checked')) {
    $.ajax({
            url: '{{route("ecommerce_subscription.publish")}}',
            method: 'POST',
...
function deleteEcommerceSubscription(id)
{
