          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{route('ecommerce_subscription.update')}}" method="post" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="number" name="product_listing" value="{{ $subscription->product_listing }}" class="form-control" required>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <?php 
                            $allOptions = json_decode($subscription->options);
                            $allOptions = !empty($allOptions) ? $allOptions : [];
                          ?>
                          @foreach($subscription_options as $row)
                          <label><input type="checkbox" name="options[]" value="{{ $row->id }}" <?php if (in_array($row->id, $allOptions)) echo "checked"; ?>/>&nbsp;&nbsp;{{ $row->title }}</label><br/>
                          @endforeach
                        </div>
                      </div>
                      <div class="col-md-12">
