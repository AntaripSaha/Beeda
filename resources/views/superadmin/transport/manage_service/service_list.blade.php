    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12" style="text-align:right;">
                <a href="{{route('transport.service.add')}}" class="btn btn-primary"><i style="font-size:25px;" class="material-icons">add</i> Add New</a>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card card-stats">
                    <div class="card-header card-header-icon">
                        <div class="card-icon" style="background-color: {{$service->color}};">
                            <img src="{{assetUrl().$service->icon_image}}" style="width:50px;" />
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            <a class="service_btn" href="{{route('transport.service.store.dashboard', ['id' => $service->id])}}" title="Home" style="color:#e863ff;"><i style="font-size:20px;" class="material-icons service_icon">home</i></a>
                            <a class="service_btn" href="{{route('transport.service.driver.list', ['id' => $service->id])}}" title="Drivers" style="color:#e863ff;"><i style="font-size:20px;" class="material-icons service_icon">store</i></a>
                            <a class="service_btn" href="{{route('transport.ride.list', ['service' => $service->id])}}" title="Rides" style="color:#e863ff;"><i style="font-size:20px;" class="material-icons service_icon">shopping_bag</i></a>
                            <a class="service_btn" href="{{route('transport.service.edit', ['id' => $service->id])}}" title="Edit" style="color:#e863ff;"><i style="font-size:20px;" class="material-icons service_icon">edit</i></a>
                        </div>
