            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <a href="{{route('super.admin.dashbaord')}}" class="btn btn-info" style="float:right;"><i class="material-icons">dashboard</i> Back Dashboard</a>
...
<script>
  $(function () {
    ...
    $("#example1").DataTable({
      ...
      serverSide: true,
      order: [0, "asc"],
      ajax: "{{ route('subscriptions.driver') }}",
      columns: [
