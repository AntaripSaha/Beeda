                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Edit Vehicle Icon</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{route('transport.vehicle-icon.update')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{$vehicleIcon->id}}"/>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Name</label>
                                            <input type="text" name="name" value="{{$vehicleIcon->name}}" class="form-control" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="">
                                            ...
                                            <br>
                                            <img src="{{env('AWS_MEDIA_URL').$vehicleIcon->icon}}" style="width:50px;height:50px;" />
                                            <br>
