...
<div class="content">
        <div class="container-fluid">
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Assign Attribute Value</h4>
                </div>
                <div class="card-body">
                  <form action="{{route('transport.courier.package-attribute.assign.value')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    @if($inputType=='pre-defined')
                    <div class="row">
                        <div class="col-md-6">
                            <label class="bmd-label-floating">Icon</label><br>
                            <input type="file" name="icon"/>
                            <img src="https://getuikit.com/v2/docs/images/placeholder_600x400.svg" id="icon" style="width: 50px;height:50px"/>
                        </div>
                    </div><br>
                    @endif
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="{{route('transport.courier.package-attribute.list')}}" class="btn btn-success pull-left">Back</a>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0" style="padding-top: 7px;margin-left: 5px;font-size: 17px;">Attribute Values</h4>
                </div>
                <div class="card-body">
...
<script>
  $(function () {
    $("#example1").DataTable({
      ...
      serverSide: true,
      order: [0, "desc"],
      ajax: "{{ route('transport.courier.package-attribute.attribute.values', ['id' => $id]) }}",
      columns: [
          {data: 'id', name: 'id'},
  ...
  function cancelEdit()
  {
    ...
    document.getElementById('icon').setAttribute('src', 'https://getuikit.com/v2/docs/images/placeholder_600x400.svg');
  }
