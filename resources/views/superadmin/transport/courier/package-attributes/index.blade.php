...
<div class="content">
        <div class="container-fluid">
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <a href="{{route('transport.courier.package-attribute.create')}}" class="btn btn-info" style="float:right;"><i class="material-icons">add</i> Add New</a>
                  <h4 class="card-title mt-0" style="padding-top: 7px;margin-left: 5px;font-size: 17px;">Courier Package Attributes</h4>
                </div>
                <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="{{route('transport.service.store.dashboard',['id'=> App\Constants\ServiceCategoryType::COURIER])}}" class="btn btn-dark pull-left">Back</a>
            </div>
          </div>
        </div>
      </div>
...
<script>
  $(function () {
    $("#example1").DataTable({
      ...
      serverSide: true,
      order: [0, "desc"],
      ajax: "{{ route('transport.courier.package-attribute.list') }}",
      columns: [
          {data: 'id', name: 'id'},
