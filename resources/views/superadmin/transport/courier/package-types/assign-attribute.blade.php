          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{route('transport.courier.package-type.store.attribute')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2">
                          <label class="bmd-label-floating">
                            <input type="checkbox" value="{{$attribute->id}}" name="attributes[]" {{ in_array($attribute->id, $packageTypes) ? 'checked' : '' }} />&nbsp;&nbsp;&nbsp;{{$attribute->title}}
                          </label>
                      </div>
                      @endforeach
                      <span style="color:red;float:left;font-size:13px;">{{ $errors->first('attributes') }}</span>
                    </div>
