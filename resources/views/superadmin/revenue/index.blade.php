      ...
      <div class="col-md-12">
        <div class="card card-plain">
          <div class="card-header card-header-primary">
            <h4 class="card-title mt-0" style="padding-top: 7px;margin-left: 5px;font-size: 17px;"> Revenue History</h4>
          </div>
          <div class="card-deck">
            <div class="card btn btn-info">
              <div class="card-body">
                <h5 class="card-title" style="color:white">Revenue From Sales</h5>
                <h3 class="card-text"><b>${{$totalRevenueFromSales}}</b></h3>
                <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
              </div>
            </div>
            <div class="card  btn btn-primary">
              <div class="card-body">
                <h5 class="card-title"  style="color:white">Revenue From Transactions</h5>
                <h3 class="card-text"><b>${{$totalRevenueFromTransactions}}</b></h3>
                <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
              </div>
            </div>
            <div class="card  btn btn-success">
              <div class="card-body">
                ...
                <h3 class="card-text"><b>${{$totalRevenue}}</b></h3>
                <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
              </div>
            </div>
          </div>
