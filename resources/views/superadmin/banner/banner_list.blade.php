            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <a href="{{route('banner.add')}}" class="btn btn-info" style="float:right;"><i class="material-icons">add</i> Add New</a>
                  <h4 class="card-title mt-0" style="padding-top: 7px;margin-left: 5px;font-size: 17px;">Banner List</h4>
                </div>
                <div class="card-body">
...
function publish(id)
{
  ...
  if($(mainParent).find('input.publish'+id).is(':checked')) {
    $.ajax({
            ...
            method: 'POST',
            data: {'banner_id': id, '_token': '{{csrf_token()}}'},
