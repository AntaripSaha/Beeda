    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-plain">
          ...
          <div class="card-body">
            <form action="{{route('update.home.section.category')}}" method="post" enctype="multipart/form-data">
              @csrf
                <h3>Section 1</h3><br>
                <div class="row">
                  <div class="col-md-6" style="margin-top: 35px !important;">
                    <div class="form-group">
                      ...
                      <input type="text" name="section_name_1" value="{{ get_setting('home_category_section_1_name') }}" class="form-control" require>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group ">
                      ...
                      <select class="form-control" name="section_1_value" required id="section_1_value">
                          ...
                          @foreach($categories as $category)                         
                            @if($category->id == get_setting('home_category_section_1'))
                ...
                <div class="row">
                  <div class="col-md-6" style="margin-top: 35px !important;">
                    <div class="form-group">
                      <label class="bmd-label-floating">Section Name</label>
                      <input type="text" value="{{ get_setting('home_category_section_2_name') }}" name="section_name_2" class="form-control" require>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group ">
                      ...
                      <select class="form-control" name="section_2_value" required id="section_2_value">
                          <option value="">Select Option</option>
                          @foreach($categories as $category)                         
                            @if($category->id == get_setting('home_category_section_2'))
                              <option selected value="{{$category->id}}">{{$category->name}}</option>
                            @else
                              <option value="{{$category->id}}">{{$category->name}}</option>
                            @endif
                ...
                <div class="row">
                  <div class="col-md-6" style="margin-top: 35px !important;">
                    <div class="form-group">
                      <label class="bmd-label-floating">Section Name</label>
                      <input type="text" name="section_name_3" value="{{ get_setting('home_category_section_3_name') }}" class="form-control" require>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group ">
                      ...
                      <select class="form-control"  name="section_3_value" required id="section_3_value">
                          <option value="">Select Option</option>
                          @foreach($categories as $category)                         
                            @if($category->id == get_setting('home_category_section_3'))
                              <option selected value="{{$category->id}}">{{$category->name}}</option>
                            @else
                              <option value="{{$category->id}}">{{$category->name}}</option>
                            @endif
