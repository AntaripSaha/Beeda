...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Delivery Zone</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Edit Delivery Zone</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Small boxes (Stat box) -->
                      <!-- form start -->
        <form action="{{route('edit.delivery.zone.submit')}}" method="post" enctype="multipart/form-data">
        @csrf
              ...
              <!-- /.card-header -->
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="city" value="{{$zone->name}}" id="city" placeholder="Enter City Name">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" step="any" min="1" class="form-control" value="{{$zone->cost}}" name="cost" id="cost" placeholder="Enter Cost">
                    <span style="color:red;font-size:13px;">{{ $errors->first('cost') }}</span>
                  </div>
                  <button type="submit" class="btn btn-sm float-right" style="background-color:#061880;border: 1px solid #061880;color:white;margin-left: 4px;">Update</button>
                </div>
                <!-- /.card-body -->
            </div>
