...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <!-- form start -->
      <form action="{{route('realestate.edit.property.submit')}}" method="post" enctype="multipart/form-data">
        @csrf  
        <input type="hidden" name="property_id" value="{{$property_data->property->id}}"/>  
        ...
        <div class="row">
          <div class="col-8">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="property_name" value="{{$property_data->property->name}}" id="property_name" placeholder="Enter Property Name">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2bs4" style="width: 100%;" name="category" id="category">
                    ...
                    <option value="{{$category->id}}" @if($property_data->property->category_id == $category->id) selected @endif>{{$category->name}}</option>
                ...
                <div class="form-group">
                  ...
                  <div class="bs-example">
                    <input type="text" name="tags" value="{{$property_data->property->tags}}" data-role="tagsinput">
                  </div>
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">Gallery Image</label>
                  @if(isset($property_data->gallery_images) && $property_data->gallery_images != null)
                      @foreach($property_data->gallery_images as $image)
                ...
                <div class="form-group">
                  ...
                  @if($property_data->property->thumbnail)
                      <img src="{{assetUrl().$property_data->property->thumbnail->file_name}}" style="width:150px;height:100px"/>
                  @endif
                  ...
                  <input type="number" class="form-control" min="0" name="bed" value="{{$property_data->property->bed}}" id="bed" placeholder="0">
                  <span style="color:red;font-size:13px;">{{ $errors->first('bed') }}</span>
                </div>
				        <div class="form-group">
                  <label for="bath">Number of Baths</label>
                  <input type="number" class="form-control" min="0" name="bath" value="{{$property_data->property->bath}}" id="bath" placeholder="0">
                  <span style="color:red;font-size:13px;">{{ $errors->first('bath') }}</span>
                </div>
				        <div class="form-group">
                  <label for="area">Area</label>
                  <input type="number" class="form-control" min="0" name="area" value="{{$property_data->property->area}}" id="area" placeholder="100">
                  <span style="color:red;font-size:13px;">{{ $errors->first('area') }}</span>
                </div>
				        <div class="form-group">
                  <label for="plot_area">Plot Area</label>
                  <input type="number" class="form-control" min="0" name="plot_area" value="{{$property_data->property->plot_area}}" id="plot_area" placeholder="100">
                  ...
                  <select name="property_type" class="form-control" id="property_type">
                    <option value="0" @if($property_data->property->property_type == 0) selected @endif>Sell</option>
                    <option value="1" @if($property_data->property->property_type == 1) selected @endif>Rent</option>
                  </select>
                  <span style="color:red;font-size:13px;">{{ $errors->first('property_type') }}</span>
                </div>
				        <div class="form-group">
                  <label for="price">Price</label>
                  <input type="number" class="form-control" min="0" name="price" value="{{$property_data->property->unit_price}}" id="price" placeholder="100">
                  <span style="color:red;font-size:13px;">{{ $errors->first('price') }}</span>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="address" value="{{$property_data->property->address}}" id="address" class="form-control" placeholder="Choose from map">
                            <input type="hidden" name="address_long" value="{{$property_data->property->longitude}}" id="lng" class="form-control">
                            <input type="hidden" name="address_lat" value="{{$property_data->property->latitude}}" id="lat" class="form-control">
                        </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-12">
                        <input id="searchInput" name="store_address" value="{{$property_data->property->address}}"
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select name="interior_status" id="interior_status" class="form-control">
                    ...
                    <option value="0" @if($property_data->interior_features->status == 0) selected @endif>Sell</option>
                    <option value="1" @if($property_data->interior_features->status == 1) selected @endif>Rent</option>
                  </select>
                  <span style="color:red;font-size:13px;">{{ $errors->first('interior_status') }}</span>
                </div>
                <div class="form-group">
                  <label for="interior_living_area">Living Area</label>
                  <input type="number" min="1" name="interior_living_area" value="{{$property_data->interior_features->living_area}}" id="interior_living_area" class="form-control" placeholder="1848" />
                  <span style="color:red;font-size:13px;">{{ $errors->first('interior_living_area') }}</span>
                </div>
                <div class="form-group">
                  <label for="interior_type">Type</label>
                  <input type="text" name="interior_type" value="{{$property_data->interior_features->type}}" id="interior_type" class="form-control" placeholder="Condo" />
                  <span style="color:red;font-size:13px;">{{ $errors->first('interior_type') }}</span>
                </div>
                <div class="form-group">
                  <label for="interior_year_built">Year Built</label>
                  <input type="text" name="interior_year_built" value="{{$property_data->interior_features->year_built}}" id="interior_year_built" class="form-control" placeholder="1994" />
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="interior_life_styles" value="{{$property_data->interior_features->lifestyles}}" id="interior_life_styles" class="form-control" placeholder="Beach" />
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select name="exterior_status" id="exterior_status" class="form-control">
                    <option value="">Select</option>
                    <option value="0" @if($property_data->exterior_features->status == 0) selected @endif>Sell</option>
                    <option value="1" @if($property_data->exterior_features->status == 1) selected @endif>Rent</option>
                  </select>
                  <span style="color:red;font-size:13px;">{{ $errors->first('exterior_status') }}</span>
                </div>
                <div class="form-group">
                  <label for="exterior_living_area">Living Area</label>
                  <input type="number" min="1" name="exterior_living_area" value="{{$property_data->exterior_features->living_area}}" id="exterior_living_area" class="form-control" placeholder="1848" />
                  <span style="color:red;font-size:13px;">{{ $errors->first('exterior_living_area') }}</span>
                </div>
                <div class="form-group">
                  <label for="exterior_type">Type</label>
                  <input type="text" name="exterior_type" value="{{$property_data->exterior_features->type}}" id="exterior_type" class="form-control" placeholder="Condo" />
                  <span style="color:red;font-size:13px;">{{ $errors->first('exterior_type') }}</span>
                </div>
                <div class="form-group">
                  <label for="exterior_year_built">Year Built</label>
                  <input type="text" name="exterior_year_built" value="{{$property_data->exterior_features->year_built}}" id="exterior_year_built" class="form-control" placeholder="1994" />
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="exterior_life_styles" value="{{$property_data->exterior_features->lifestyles}}" id="exterior_life_styles" class="form-control" placeholder="Beach" />
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select name="area_status" id="area_status" class="form-control">
                    <option value="">Select</option>
                    <option value="0" @if($property_data->area_features->status == 0) selected @endif>Sell</option>
                    <option value="1" @if($property_data->area_features->status == 1) selected @endif>Rent</option>
                  </select>
                  <span style="color:red;font-size:13px;">{{ $errors->first('area_status') }}</span>
                </div>
                <div class="form-group">
                  <label for="area_living_area">Living Area</label>
                  <input type="number" min="1" name="area_living_area" value="{{$property_data->area_features->living_area}}" id="area_living_area" class="form-control" placeholder="1848" />
                  <span style="color:red;font-size:13px;">{{ $errors->first('area_living_area') }}</span>
                </div>
                <div class="form-group">
                  <label for="area_type">Type</label>
                  <input type="text" name="area_type" value="{{$property_data->area_features->type}}" id="area_type" class="form-control" placeholder="Condo" />
                  <span style="color:red;font-size:13px;">{{ $errors->first('area_type') }}</span>
                </div>
                <div class="form-group">
                  <label for="area_year_built">Year Built</label>
                  <input type="text" name="area_year_built" value="{{$property_data->area_features->year_built}}" id="area_year_built" class="form-control" placeholder="1994" />
                  <span style="color:red;font-size:13px;">{{ $errors->first('area_year_built') }}</span>
                </div>
                <div class="form-group">
                  <label for="area_life_styles">Life Styles</label>
                  <input type="text" name="area_life_styles" value="{{$property_data->area_features->lifestyles}}" id="area_life_styles" class="form-control" placeholder="Beach" />
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <select class="form-control" name="video_provider" id="video_provider">
                    <option value="youtube" @if($property_data->property->video_provider == "youtube") selected @endif>Youtube</option>
                    <option value="dailymotion" @if($property_data->property->video_provider == "dailymotion") selected @endif>Dailymotion</option>
                    <option value="vimeo" @if($property_data->property->video_provider == "vimeo") selected @endif>Vimeo</option>
                  </select>
                </div>
                <div class="form-group">
                  <label for="video_link">Video Link</label>
                  <input type="text" name="video_link" id="video_link" value="{{$property_data->property->video_link}}" class="form-control" placeholder="Video Link" />
                </div>
              </div>
              <!-- /.card-body -->
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="meta_title" value="{{$property_data->property->meta_title}}" id="meta_title" placeholder="Enter Meta Title">
                </div>
                <div class="form-group">
                  <label for="meta_description">Description</label>
                  <textarea class="summernote" name="meta_description">
                    {{$property_data->property->meta_description}}
                    </textarea>
                </div>
                <div class="form-group">
                  <label for="meta_image">Meta Image</label>
                  @if($property_data->property->meta_image)
                      <img src="{{assetUrl().$property_data->property->meta_image->file_name}}" style="width:150px;height:100px"/>
                  @endif
            ...
            <!-- seo meta tags end -->
            <input type="hidden" id="place_id" value="{{$property_data->property->place_id}}" name="place_id"/>
            <input type="submit" value="Update" class="btn float-right" style="background-color: #061880;color: white;"/>
            <br>
            <br>
          </div>
        </div>
...
<script src="//maps.googleapis.com/maps/api/js?key={{env('GOOGLE_API_KEY')}}&libraries=places"></script>
    ...
    // google map
    function initialize() {
        @if(isset($property_data->property) && $property_data->property->latitude != Null && $property_data->property->longitude != Null)
            var lati = '{{ $property_data->property->latitude }}';
            var longi = '{{ $property_data->property->longitude }}';
