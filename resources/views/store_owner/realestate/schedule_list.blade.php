      ...
      <div class="container-fluid">
        ...
        <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title" style="color:black;">Schedule DataTable</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script>
  $(function () {
    $("#example1").DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: "{{ route('realestate.schedule.list', ['id'=>$service_category_id]) }}",
      columns: [
...
function publish(id)
{
  ...
  if($(mainParent).find('input.publish'+id).is(':checked')) {
    $.ajax({
            url: '{{route("realestate.property.publish")}}',
            method: 'POST',
