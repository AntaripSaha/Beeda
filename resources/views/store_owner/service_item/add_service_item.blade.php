              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2bs4" style="width: 100%;" name="category" id="category" required>
                    ...
                    @if(isset($category->child_categories) && count($category->child_categories)>0)
                ...
                <div class="form-group">
                  ...
                  <span class="btn btn-info fileinput-button">
                    ...
                    <input type="file" name="gallery_images[]" id="files" multiple accept="video/*,image/jpeg, image/png, image/gif " required><br />
                  </span>
                  ...
                  <div class="provide box mt-3 border-top" id="provide">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-8">
                              ...
                              <input type="text" class="form-control" name="video_link" id="video_link" onclick="linkUpload(this)"
...
<script>
    function linkUpload(video_link){
        $('#product_video_file').val(null);
    }
  function checkVideoDuration(product_video_file)
  {
      ...
      video.onloadedmetadata = function () {
          ...
          const fi = document.getElementById('product_video_file');
          if (fi.files.length > 0) {
              ...
              if (file >= 2048) {
                  ...
                  alert('Sorry the video size is greater than 2MB. Please upload video max 2MB.');
                  return;
              }
          }
      }
      $('#video_link').val('');
      video.src = URL.createObjectURL(product_video_file.files[0]);
  }
  ...
  function ApplyFileValidationRules(readerEvt) {
    ...
    if (CheckFileType(readerEvt.type) == false) {
      alert(
        "The file (" +
        readerEvt.name +
        ") does not match the upload conditions, You can only upload jpg/png/gif or video mp4/mov/wmv/avi files"
      );
      e.preventDefault();
      return;
    }
