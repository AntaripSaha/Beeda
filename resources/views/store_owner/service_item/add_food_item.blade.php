...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Add Food Product</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Add Food Product</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <form action="{{route('service.add.item.submit')}}" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="vegetarian" value="0" id="veg" />
        <div class="row">
          <div class="col-8">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="description">Cuisines</label>
                  <select class="cuisine-basic-multiple form-control" name="cuisines[]" multiple="multiple">
                    @if($data)
                ...
                <div class="form-group">
                  <label for="service_description">Service Description</label>
                    <textarea class="summernote" name="service_description"></textarea>
                </div>
                ...
                <div class="form-group">
                  <label for="food_preparation_time">Food Preparation Time (In minuites) <span class="text-danger" title="Required">*</span></label>
                  <input type="number" min='1' step="any" class="form-control" name="food_preparation_time" id="food_preparation_time" placeholder="" required>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="toggle-btn" style="margin:0px;float:right;">
                      <input type="checkbox" onclick="colorField()" class="cb-value color_field" />
                      <span class="round-btn"></span>
                    </div>
                    <!-- <input type="checkbox" onchange="colorField()" name="variant_checkbox" data-bootstrap-switch data-off-color="danger" data-on-color="success"> -->
                    <select class="form-control select2bs4" name="color[]" onchange="getVariantByColor()" id="color" multiple="multiple" data-placeholder="Select Colors" disabled>
                      @if($data)
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <input type="number" step="any" min="0" class="form-control" value="0" name="discount" id="discount" placeholder="0">
                      </div>
                      <div class="col-3"></div>
                      <div class="col-3">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="toggle-btn" style="margin:0px;float:right;">
                    <input type="checkbox" name="free_shipping" onchange="config('free')" class="cb-value free_shipping" />
                    <span class="round-btn"></span>
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="toggle-btn" style="margin:0px;float:right;">
                    <input type="checkbox" name="veg" onchange="vegStatus()" class="cb-value veg" />
                    <span class="round-btn"></span>
                  </div>
                </div>
              </div>
...
<script>
  ...
  function vegStatus() {
    var mainParent = $('.veg').parent('.toggle-btn');
    if ($(mainParent).find('input.veg').is(':checked')) {
      $(mainParent).addClass('active');
