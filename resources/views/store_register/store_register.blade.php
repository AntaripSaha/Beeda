                ...
                <div class="wizard">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="@if($page_type == null) active @endif">
                                <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab"
                                   aria-expanded="true"><span class="round-tab">1 </span> <i>Personal Details</i></a>
                            </li>
                            <li role="presentation"
                                class="@if($page_type && $page_type == 'service') disabled active @else disabled @endif">
                                <a href="#step2" data-toggle="tab"
                                   @if($page_type && $page_type == 'service') class="active show"
                                   @endif aria-controls="step2" role="tab"
                                   aria-expanded="@if($page_type && $page_type == 'service') true @else false @endif"><span
                                        class="round-tab">2</span> <i>Choose Services</i></a>
                            </li>
                            <li role="presentation"
                                class="@if($page_type && $page_type == 'store') disabled active @else disabled @endif">
                                <a href="#step3" data-toggle="tab"
                                   @if($page_type && $page_type == 'store') class="active show"
                                   @endif aria-controls="step3"
                                   aria-expanded="@if($page_type && $page_type == 'store') true @else false @endif"
                                   role="tab"><span class="round-tab">3</span> <i>Store Details</i></a>
                            </li>
                    ...
                    <div class="tab-content" id="main_form">
                        <div class="tab-pane @if($page_type == null) active @endif" role="tabpanel" id="step1">
                            ...
                            <form action="{{route('register.update.personal.details')}}" id="personal_details_form"
                                  method="post">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="first_name"
                                                   value="{{$user->first_name}}" name="first_name" placeholder="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="last_name"
                                                   value="{{$user->last_name}}" name="last_name" placeholder="">
                                            <small class="last_name_error_message error_message"></small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Email Address <small style="color:#80926c;">(Not
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="contact_number"
                                                   value="{{$user->contact_number}}" name="contact_number"
                                                   placeholder="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Gender: &nbsp;<input type="radio" name="gender" value="1"
                                                                        @if($user->gender == 1) checked @endif>&nbsp;Male</label>
                                            &nbsp;&nbsp;&nbsp;<label><input type="radio" name="gender" value="2"
                                                                            @if($user->gender == 2) checked @endif>&nbsp;Female</label>
                            ...
                            <ul class="list-inline pull-right">
                                <li>
                                    <button type="button" style="color:white;cursor:pointer;"
                                            data-personal-details="personal_details" class="default-btn next-step">
                                        Update
                                    </button>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-pane @if($page_type && $page_type == 'service') active show @endif"
                                ...
                                <div class="col-md-12">
                                    <form action="{{route('register.add.services')}}" id="service_form" method="post">
                                        ...
                                        <input type="hidden" name="service_user_id"
                                               value="{{session()->get('user_info')->user_id}}"/>
                                        <div class="form-group">
                                            @foreach($services as $singleService)
                                                <input type="checkbox" class="service_checkbox"
                                                       name="service_category_id[]" value="{{$singleService->id}}"
                                                       @if(in_array($singleService->id, $selected_services_ids)) disabled
                                                       checked @endif/>&nbsp;{{$singleService->name}}
                                                &nbsp;&nbsp;
                                            @endforeach
                                        </div>
                                    </form>
                            ...
                            <ul class="list-inline pull-right">
                                ...
                                <li>
                                    <button type="button" style="color:white;cursor:pointer;" data-service="services"
                                            class="default-btn next-step">Add
                                    </button>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-pane @if($page_type && $page_type == 'store') active show @endif"
                            ...
                            <div class="row">
                                <div class="col-md-12" style="text-align:center;">
                                    ...
                                    @foreach($seller_services as $service)
                                        @if($service->shop)
                                            <button class="btn btn-sm btn-info" disabled><i class="fas fa-check"
                                                                                            style="color:#ff7716"></i>{{$service->service_category->name}}
                                            </button>
                                        @else
                                            <a href="javascript:;"
                                               onclick="setServiceId('{{$service->service_category_id}}')"
                                               class="btn btn-sm btn-info">{{$service->service_category->name}}</a>
                                        @endif
                                    @endforeach
                                </div>
                            </div>
                            <br>
                            <form action="{{route('register.add.store.details')}}" id="store_details_form" method="post"
                                ...
                                <div class="row p-0">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" min="1" step="any"
                                                   id="delivery_radius" name="delivery_radius" placeholder="" required>
                                    ...
                                    <div class="col-md-4 p-0">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" min="1" step="any"
                                                   id="delivery_time" name="delivery_time" placeholder="" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row" style="margin-top: 40px">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label>Order Minimum Amount</label>
                                                        <input class="form-control" type="text" name="order_min_amount"
                                                               placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                ...
                                                <input type="checkbox" name="pickup_status" id="pickup_status"
                                                       onclick="pickupStatusChanged()">
                                            </span>
                                                            <span style="margin-left: 10px;">(Pickup ON/OFF)</span>
                                                        </label>
                                                        <input type="text" class="form-control timepicker"
                                                               name="pickup_time_start" id="pickup_time_start"
                                                               placeholder="Pickup time start" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control timepicker"
                                                               name="pickup_time_end" id="pickup_time_end"
                                                               placeholder="Pickup time end" style="margin-top: 32px;"
                                                               disabled>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <!--<div class="col-md-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label for="store_name">Store Banner for desktop view(1370x200px)<span style="color: red">*</span></label>
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label for="store_name">Store Banner for mobile view (197x100)<span style="color: red">*</span></label>
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label for="store_logo">Store Logo (100x100)<span style="color: red">*</span></label>
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 mb-5 p-0">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="file"
                                                       class="1370-200-137-20-desktop_banner_preview-crop_desktop_logo"
                                                       name="" id="image_logo">
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <img src="" id="desktop_banner_preview" style="height:100px;"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-5 p-0">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label for="store_name">Store Banner for mobile view (480x240)<span
                                                        style="color: red">*</span></label>
                                            </div>
                                            <div class="col-md-12">
                                                <input type="file"
                                                       class="480-240-2-1-mobile_banner_preview-crop_mobile_logo"
                                                       name="" id="image_logo">
                                            </div>
                                            <div class="col-md-12 mt-2">
                                    ...
                                    <div class="col-md-12 mb-5 p-0">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label for="store_name">Store Logo (100x100)<span
                                                        style="color: red">*</span></label>
                                            </div>
                                            <div class="col-md-12">
                                                <input type="file" class="100-100-1-1-logo_preview-crop_logo" name=""
                                                       id="image_logo"/>
                                            </div>
                                            <div class="col-md-12 mt-2">
                                ...
                                <ul class="list-inline pull-right">
                                    ...
                                    <li>
                                        <button type="button" style="color:white;cursor:pointer;"
                                                data-store-details="store_details" class="default-btn next-step">Save
                                        </button>
                                    </li>
                                </ul>
