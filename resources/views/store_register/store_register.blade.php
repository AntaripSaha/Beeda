                        ...
                        <!-- <form role="form" action="index.html" class="login-box"> -->
                            <div class="tab-content" id="main_form">
                                    ...
                                    <div class="row p-0">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Delivery Radius <span
                                                            style="color: red">*</span></label>
                                                <input class="form-control" type="number" min="1" step="any" id="delivery_radius" name="delivery_radius" placeholder="" required>
                                        ...
                                        <div class="col-md-4 p-0">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" min="1" step="any" id="delivery_time" name="delivery_time" placeholder="" required>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <label for="pickup_time">
                                            ...
                                            <span style="margin-left: 10px;">
                                                <input type="checkbox" name="pickup_status" id="pickup_status" onclick="pickupStatusChanged()">
                                            </span>
                                            <span style="margin-left: 10px;">(Pickup ON/OFF)</span>
                                        </label>
                                        <input type="text" class="form-control timepicker" name="pickup_time_start" id="pickup_time_start" placeholder="Pickup time start" disabled>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="pickup_time" class="sr-only">Pickup Time End</label>
                                            <input type="text" class="form-control timepicker" name="pickup_time_end" id="pickup_time_end" placeholder="Pickup time end" style="margin-top: 32px;" disabled>
                                        </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-12 mb-5 p-0">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="store_name">Store Banner for mobile view (480x240)<span style="color: red">*</span></label>
                                        </div>
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-12 mb-5 p-0">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="store_name">Store Logo (100x100)<span style="color: red">*</span></label>
                                        </div>
                                        <div class="col-md-12">
