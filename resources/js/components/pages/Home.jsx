...
const Home = () => {
    ...
    return (
        <>
            {/* <section id="intro" style={{backgroundImage: `url('https://d2t5292uahafuy.cloudfront.net/public/img/home_banner.png')`,backgroundPosition: "center",backgroundRepeat: "no-repeat",backgroundSize: "cover"}}>
                <div className="intro-text ">
                    <div className="row">
                        <div className="banner_span d-flex justify-content-center align-items-center">
                            <span>We're</span><img className="banner_beeda_logo" src={`${CDN_URL}assets/front/img/beeda_logo.svg`} alt="beeda"/>
                        </div>
                    </div>
                    <p className="banner_text">The world’s first & only <a href="https://www.youtube.com/watch?v=_OQ_lhjanKA" target="_blank">Mega App</a></p>
                    <p className="banner_text">Experience <a href="https://www.youtube.com/watch?v=R2Bad2FH5fA" target="_blank">Beeda</a> Today</p>
                </div>
            </section> */}
            <img
                        ...
                        <Swiper slidesPerView={"auto"}   >
                            ...
                            <SwiperSlide>
                                <div className="over-slider-item">
                                    <div className="over-slider-item-img-content">
                                        <img
                                            src="/img/Grocery Icon low 1.png"
                                            alt="bag"
                                        />
                                    </div>
                                    <p>Grocery</p>
                        ...
                        <Swiper slidesPerView={"auto"} loop={true}>
                            ...
                            <SwiperSlide>
                                <div className="over-slider-item">
                                    <div className="over-slider-item-img-content">
                                        <img
                                            src="/img/food-delivery-box 1.png"
                                            alt="bag"
                                        />
                                    </div>
                                    <p>Food Delivery</p>
                                ...
                                <div id="call-to-container">
                                    ...
                                    <div className="call-to-container-details">
                                        ...
                                        <div className="description">
                                            Our employees are efficient and
                                            committed to delivering
                                            user-friendly products and the best
                                            services to customers. Join the
                                            Beeda team to make a difference.
                                        </div>
                                        <a
                                            href=""
                                            target="_blank"
                                ...
                                <div id="call-to-container">
                                    ...
                                    <div className="call-to-container-details driver">
                                        ...
                                        <div className="description mobile-right">
                                            Working as a part-time or full-time
                                            driver, you have the opportunity to
                                            work at your convenience time. Join
                                            Beeda and start serving.
                                        </div>
                                        <a
                                            href=""
                                            target="_blank"
                                ...
                                <div id="call-to-container">
                                    ...
                                    <div className="call-to-container-details">
                                        ...
                                        <div className="description">
                                            ...
                                            list it on the Beeda platform and
                                            reach an enormous number of
                                            customers, place ads and chat with
                                            them, and get payment in your
                                            wallet.
                                        </div>
                                        <a
                                            href=""
                        ...
                        <div className="beeda-content-wrapper">
                            <div className="beeda-store-app-1">
                                <div className="w-100 pb-3">
                                    ...
                                    <p>
                                        Beeda store app allows merchants to
                                        register their shop in food, grocery,
                                        ride-sharing, liquor, gas, flower,
                                        pharmacy, travel, spa, real estate,
                                        courier, car sale, etc. sectors. As a
                                        vendor, you will be notified of new
                                        orders. You are allowed to view accepted
                                        and processing orders, change the basic
                                        information of your stores such as
                                        delivery time, opening and closing time,
                                        packaging charges, and product details,
                                        and manage inventory from the Beeda app.
                                    </p>
                                    <div className="row">
                        ...
                        <div className="beeda-content-wrapper">
                            <div className="beeda-store-app-1 flex-wrap">
                                ...
                                <div className="w-100 pb-3">
                                    ...
                                    <p>
                                        Users are allowed to order on-demand
                                        services from nearby vendors. In the
                                        Beeda platform, users can access the
                                        shops, restaurants, transport, couriers,
                                        real estate, and other essential
                                        services using a single app. As a user,
                                        you can manage your profile, delivery
                                        address, order scheduling, and payment
                                        system. Also, you are allowed to use
                                        promo codes to get discounts and view
                                        all reviews & ratings of merchants.
                                    </p>
                                    <div className="row">
                                        <div className="col-12 col-sm-8">
                                            <div className="row">
                                    ...
                                    <div className="col-lg-5 col-md-5 col-sm-12 col-12">
                                        <div className="voucher-text">
                                            ...
                                            <div className="voucher-text">
                                                ...
                                                <p>
                                                    Purchase the Beeda gift card
                                                    or voucher, add it to your
                                                    wallet and make payments for
                                                    products and services, pay
                                                    utility bills, and transfer
                                                    funds to your friend’s
                                                    wallets.{" "}
                                                </p>
                                            </div>
                                        </div>
                                ...
                                >
                                    <div className="deliver-part">
                                        <h1 className="supperapp-tagline">
                                            Beeda is Crossing boundaries to
                                            deliver smiles.
                                        </h1>
                                    </div>
                                </div>
                                ...
                                <div className="col-12 col-sm-6 col-md-6 col-lg-3 p-3">
                                    <div className="service-details-content-items">
                                        ...
                                        <div className="details">
                                            <h3>50+ Services</h3>
                                            <p>
                                                Beeda mega app allows to access
                                                more than 50 on-demand services.
                                            </p>
                                        </div>
                                    </div>
                                </div>
